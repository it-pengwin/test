...
Разделение по диапазону — это тип разделения таблицы, при котором данные делятся на разделы на основе указанного диапазона значений в столбце. Это особенно полезно при работе с данными временных рядов или любыми данными, имеющими естественный порядок. Каждый раздел представляет собой отдельный диапазон значений, и данные, попадающие в этот диапазон, хранятся в этом разделе. Разделение по диапазону позволяет эффективно извлекать данные в определенных диапазонах, что приводит к повышению производительности запросов.
